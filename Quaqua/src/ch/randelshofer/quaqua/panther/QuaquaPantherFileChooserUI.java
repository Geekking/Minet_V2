 ...
 * @version $Id: QuaquaPantherFileChooserUI.java 388 2011-07-04 09:48:46Z wrandelshofer $
 */
   ...
   /// private String homeFolderAccessibleName = null;
    ...
    private AbstractAction keyListenerAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            //set the file if non-null:
            if (file != null) {
                // if the file is in the sidebar,
    ...
    private void updateSelection() {
        ...
        if (files.length != 0) {
            ...
            if (!subtreeModel.isDescendant(fullPath)) {
                ...
                // FIXME - Select the file system root in the sidebar!!!
...
//->The Update did not occur from the browser        updateFileChooserFromBrowser();
    ...
    protected SidebarRenderer createVolumesRenderer(JFileChooser fc) {
    ...
    // *******************************************************
    private class SidebarSelectionListener implements ListSelectionListener {
